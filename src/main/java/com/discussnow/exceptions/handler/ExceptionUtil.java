...
public interface ExceptionUtil {
  default ResponseEntity<AbstractExceptionTemplate> buildExceptionTemplate(DomainObject domainObject, Long domainObjectId, String message, String resolution, HttpStatus status) {
